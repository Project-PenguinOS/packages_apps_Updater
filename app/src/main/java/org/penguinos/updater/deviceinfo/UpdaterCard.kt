            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                Row(
                    ...
                    Image(
                        ...
                        // Penguin mark is square (unlike the old wide Lineage mark), so size it
                        // by height and keep 1:1. Tune the multiplier if it reads too big/small.
                        modifier = Modifier
                            .height(markWidth)
                            .aspectRatio(1f)
                            .alignBy { it.measuredHeight },
                        contentScale = ContentScale.Fit,
                        // Brand guide: white mark on the dark/orange header.
